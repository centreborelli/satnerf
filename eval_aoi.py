...
def load_nerf(run_id, log_path, checkpoints_dir, epoch_number):
    ...
    for i in samples_to_eval:
        ...
        for k in sample.keys():
            if torch.is_tensor(sample[k]):
                ...
                sample[k] = [sample[k]]
        out_dir = os.path.join(output_dir, "eval_aoi", run_id)
