...
python3 main.py --root_dir $satnerf_data_dir/$aoi_id --img_dir $DFC2019_dir/Track3-RGB/$aoi_id --config_name nerf --cache_dir $satnerf_data_dir/$aoi_id/cache_$imsize --img_downscale $downsample_factor --exp_name "$exp_name"_"$suffix" --checkpoints_dir $out_dir/checkpoints --logs_dir $out_dir/logs --gt_dir $DFC2019_dir/Track3-Truth --gpu_id $gpu_id --solarloss_lambda 0 2>> $errs
...
python3 main.py --root_dir $satnerf_data_dir/"$aoi_id"_ba --img_dir $DFC2019_dir/Track3-RGB/$aoi_id --config_name s-nerf-w --cache_dir $satnerf_data_dir/"$aoi_id"_ba/cache_$imsize --img_downscale $downsample_factor --exp_name "$exp_name"_"$suffix" --checkpoints_dir $out_dir/checkpoints --logs_dir $out_dir/logs --gt_dir $DFC2019_dir/Track3-Truth --gpu_id $gpu_id --solarloss_lambda 0 2>> $errs

# Sat-NeRF + BA + DS
exp_name="$aoi_id"_"$imsize"_satnerf_BA_DS
python3 main.py --root_dir $satnerf_data_dir/"$aoi_id"_ba --img_dir $DFC2019_dir/Track3-RGB/$aoi_id --config_name s-nerf-w --cache_dir $satnerf_data_dir/"$aoi_id"_ba/cache_$imsize --img_downscale $downsample_factor --exp_name "$exp_name"_"$suffix" --checkpoints_dir $out_dir/checkpoints --logs_dir $out_dir/logs --gt_dir $DFC2019_dir/Track3-Truth --gpu_id $gpu_id --solarloss_lambda 0 --depth_supervision 2>> $errs
